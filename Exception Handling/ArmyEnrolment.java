...
class CountryValidationException extends Exception {
    ...
    CountryValidationException(String s) {
        super(s);
    }
}

class HeightValidationException extends Exception {

    HeightValidationException(String s) {
        super(s);
    }
}

class WeightValidationException extends Exception {

    WeightValidationException(String s) {
        super(s);
    }
}
